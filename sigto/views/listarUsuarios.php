                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($usuario['activo'] == 'si'): ?>
                            <button class="btn view-logins-btn" onclick="cambiarEstado(<?php echo $usuario['idus']; ?>, 'no')">Dar de baja</button>
                        <?php else: ?>
                            <button class="btn view-logins-btn" onclick="cambiarEstado(<?php echo $usuario['idus']; ?>, 'si')">Dar de alta</button>
                        <?php endif; ?>
